...
/// Deserializes a value that can be either a string or an integer into a String.
///
/// SDP API sometimes returns IDs as integers and sometimes as strings,
/// so this helper handles both cases.
